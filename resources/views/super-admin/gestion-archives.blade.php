                ...
                <div class="panel panel-info">
                    <div class="panel-heading">Espace de recherche sur les archives</div>
                        <div class="panel-body">
                            <form class="form-horizontal row" id="user_userAccountForm" method="POST" action="{{ route('archives.searchFromAdmin') }}">
                                @csrf
                                <div class="col-xs-12">
                                    <br>
                                    <div class="form-group">
                                        <label for="searchBy2" class="col-md-3 control-label">Rehercher par :
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label for="searchValue2" class="col-md-3 control-label">Motif de recherche :
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="searchValue2" name="searchValue" placeholder="saisissez votre motif de recherche">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="dateDebut2" class="col-md-3 control-label">Date d'archivage après :</label>
                                        <div class="col-md-9">
                                            <input type="date" class="form-control" id="dateDebut2" name="dateDebut">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="dateEnd2" class="col-md-3 control-label">Date d'archivage avant :</label>
                                        <div class="col-md-9">
                                            <input type="date" class="form-control" id="dateEnd2" name="dateEnd">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-6 pull-right">
                                        <div class="form-group">
                                            <div >
                                                <button id="adminSearchValider" type="submit" class="btn btn-success" title="Rechercher des archives">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body" style="padding: 0;">
                            <div class="table-responsive">
                                ...
                                data-table-id="rz68hp-ijdr-awoavw" role="grid"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting_disabled" rowspan="1" colspan="1"
                                                ...
                                                style="width: 200.139px;">Date d'archivage</th>
                    ...
                    <div class="info-content" id="info-content">
                        <div  class="archiveInfos" id="infos_archiveID{{ $archive->id }}">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="bold">Direction auteur</td>
                                    <td>{{ $archive->department->name }}</td>
                                </tr>
                                <tr>
...
<script>
  ...
  var dataTableObjects = {};
    $(document).ready(function() {
        dataTableObjects['rz68hp-ijdr-awoavw'] = $('*[data-table-id="rz68hp-ijdr-awoavw"]').DataTable({
